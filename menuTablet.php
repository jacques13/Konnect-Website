...
<body style="background-image: url('images/bg2.png')">
	 ...
	 <div class="col-xs-2 col-md-2 navbar navbar-fixed-bottom" id="sidebar" style="width: 100%;height: 20%;Text-align:center;background-image: url('images/bg2.png');">
			...
			<a class="btn btn-primary btn-lg outline load" href="http://google.com" role="button" style="margin-right: 0%;">Get our App</a>
			...
			<a class="btn btn-primary btn-lg outline load" id = "share_button" role="button" style="width:initial;" >Share your ID on Facebook</a>
